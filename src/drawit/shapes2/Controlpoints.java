...
public class Controlpoints implements ControlPoint {
	...
	private drawit.shapegroups2.ShapeGroup shape;

	public Controlpoints(drawit.IntPoint vertix, int index, drawit.RoundedPolygon polygon, drawit.shapegroups2.ShapeGroup shape) {
		this.point = vertix;
		this.index = index;
